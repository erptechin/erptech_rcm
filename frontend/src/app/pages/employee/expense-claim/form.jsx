...
const pageName = "Expense Claim List"
const doctype = "Expense Claim"
const fields = ['employee', 'department', 'company', 'expense_approver', 'approval_status', 'expenses']
const subFields = ['total_claimed_amount']

const tableFields = {
  "expenses": { "expense_date": true, "expense_type": true, "amount": true, "sanctioned_amount": true }
}
