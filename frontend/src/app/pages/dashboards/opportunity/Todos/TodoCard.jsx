...
export function TodoCard({ todo, index }) {
  ...
  const { id, subject, exp_end_date, priority, color, assignedTo, isImportant, isDone } = todo;
        ...
        <Card onClick={open}>
          ...
          >
            <div className="flex min-w-0 items-center gap-2 sm:gap-3">
              ...
              >
                <Highlight query={searchQuery}>{subject}</Highlight>
              </h2>
            </div>
              ...
              <div className="flex flex-wrap items-center gap-1.5 text-xs">
                ...
                {priority &&
                  <Fragment>
                    ...
                    <span
                      className={`inline-flex items-center gap-2 leading-none text-[${color}]`}
                    >
